        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              <section>
                <h2 className="text-3xl font-bold mb-6">Задача заказчика</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6">Наше решение</h2>
                  ...
                  {project.solution.map((item, index) => (
                    <Card key={index} className="p-5">
                      <div className="flex items-start space-x-4">
                        ...
                        <p className="text-muted-foreground leading-relaxed pt-0.5">{item}</p>
                      </div>
                    </Card>
                  ))}
                </div>
              ...
              {project.gallery.length > 0 && (
                <section>
                  <h2 className="text-3xl font-bold mb-6">Фотогалерея проекта</h2>
                  <div className="grid md:grid-cols-2 gap-4">
                    {project.gallery.map((image, index) => (
                      <div key={index} className="relative h-72 rounded-xl overflow-hidden group cursor-pointer">
                        <img 
                          src={image} 
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6">Отзыв заказчика</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6">Участвующая команда</h2>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {project.team.map((member, index) => (
                    <Card key={index} className="p-5 text-center hover:shadow-lg transition-shadow">
                      ...
                      <div className="text-3xl font-bold text-accent mb-1">{member.count}</div>
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6">Связанные услуги</h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  {project.relatedServices.map((service, index) => (
                    <Card key={index} className="p-5 hover:shadow-xl transition-all hover:border-accent group cursor-pointer">
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 rounded-lg bg-accent/10 flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-colors flex-shrink-0">
                          <Icon name="Wrench" size={24} />
                        </div>
                        <span className="font-semibold group-hover:text-accent transition-colors">{service}</span>
                      </div>
                    </Card>
                  ))}
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <Card className="p-6 bg-gradient-to-br from-primary to-secondary text-white">
                  <h3 className="text-2xl font-bold mb-4">Обсудить ваш проект</h3>
                ...
                <Card className="p-6">
                  <h3 className="font-bold text-xl mb-4">Ключевые цифры</h3>
                  <div className="space-y-4">
                ...
                <Card className="p-6 bg-accent/5">
                  <h3 className="font-bold mb-4">Другие проекты</h3>
                        ...
                        >
                          <div className="relative h-32 rounded-lg overflow-hidden group">
                            ...
                            <div className="absolute bottom-2 left-2 right-2">
                              <div className="text-white font-semibold text-sm line-clamp-2">{p.title}</div>
                            </div>
                          </div>
                        </button>
                      ))}
